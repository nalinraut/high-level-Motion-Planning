...
SET(SSPP_ROOT "C:\\iml-internal\\CoreServices" CACHE PATH "SSPP path")
...
if( WIN32 )
  ...
  FIND_LIBRARY( SSPP_LIBRARY_RELEASE
               NAMES sspp.lib
               PATHS "${SSPP_ROOT}/lib" "${SSPP_ROOT}/build/lib/Release")

  FIND_LIBRARY( SSPP_LIBRARY_DEBUG
               NAMES sspp.lib
               PATHS "${SSPP_ROOT}/lib" "${SSPP_ROOT}/build/lib/Debug")
