...
//    this->goalIndex = this->stateToIndex(realGoal);
    ...
    if (isSolved) {
        ...
        cout<<"solutionIndex.size():"<<solutionIndex.size()<<endl;
        for(int i = 0; i < solutionIndex.size(); i++){
        	cout<<i<<";"<<solutionIndex[i]<<endl;
        }
        cout<<"--------------------"<<endl;
...
//    	cout<<"cost----------------\n";
//    	for(int i = 0; i < costs.dims[0]; i++){
//        	for(int j = 0; j < costs.dims[1]; j++){
//        		cout<<costs.values[i*costs.dims[0]+j]<<"\t";
//        	}
//        	cout<<endl;
//    	}
//    	cout<<"dist----------------\n";
...
//        		cout<<distances.values[i*distances.dims[0]+j]<<"\t";
//        	}
//        	cout<<endl;
//    	}getchar();
