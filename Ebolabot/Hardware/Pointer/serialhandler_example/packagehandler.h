...
const int dataOut_LEN = 3;  // number of data elements (ints) to send
const int dataIn_LEN = 3;   // number of data elements (ints) to send
const int bytesIn_LEN = 4;  // number of bytes expected to read in from other device per data message (equal to sum of bytesIn)
